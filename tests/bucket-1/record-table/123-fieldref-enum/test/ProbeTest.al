codeunit 50431 "FE Tests"
{
    ...
    begin
        ...
        // [THEN] Returns true
        Assert.IsTrue(Probe.FieldRefIsEnum(50093, 3), 'Enum field should report IsEnum = true');
    end;
    ...
    begin
        ...
        // [THEN] Returns false
        Assert.IsFalse(Probe.FieldRefIsEnum(50093, 2), 'Text field should report IsEnum = false');
    end;
    ...
    begin
        ...
        // [THEN] Returns 4
        Assert.AreEqual(4, Probe.FieldRefEnumValueCount(50093, 3), 'FE Color has 4 members');
    end;
    ...
    begin
        ...
        // [THEN] Returns 0
        Assert.AreEqual(0, Probe.FieldRefEnumValueCount(50093, 2), 'Text field has 0 enum members');
    end;
    ...
    begin
        ...
        Assert.AreEqual(' ', Probe.FieldRefGetEnumValueName(50093, 3, 1), 'Index 1 should be empty');
        Assert.AreEqual('Red', Probe.FieldRefGetEnumValueName(50093, 3, 2), 'Index 2 should be Red');
        Assert.AreEqual('Green', Probe.FieldRefGetEnumValueName(50093, 3, 3), 'Index 3 should be Green');
        Assert.AreEqual('Blue', Probe.FieldRefGetEnumValueName(50093, 3, 4), 'Index 4 should be Blue');
    end;
    ...
    begin
        ...
        Assert.AreEqual('Green', Probe.FieldRefGetEnumValueCaption(50093, 3, 3), 'Caption index 3');
        Assert.AreEqual('Blue', Probe.FieldRefGetEnumValueCaption(50093, 3, 4), 'Caption index 4');
    end;
    ...
    begin
        ...
        Assert.AreEqual(5, Probe.FieldRefGetEnumValueOrdinal(50093, 3, 3), 'Ordinal index 3');
        Assert.AreEqual(10, Probe.FieldRefGetEnumValueOrdinal(50093, 3, 4), 'Ordinal index 4');
    end;
    ...
    begin
        ...
        // [THEN] Returns 61.50
        Assert.AreEqual(61.50, Probe.CalcSumPrice(50093, 4), 'Sum of 10.50 + 20.25 + 30.75');
    end;
    ...
    begin
        ...
        // [THEN] Returns 0
        Assert.AreEqual(0, Probe.CalcSumPrice(50093, 4), 'Empty table sum should be 0');
    end;
    ...
    begin
        ...
        Assert.AreEqual(35.0, Probe.CalcSumQuantity(50093, 5), 'CalcSum on Integer field returns Decimal: 10 + 25 = 35');
    end;
    ...
    begin
        ...
        Assert.AreEqual(50.00, Probe.CalcSumPriceWithFilter(50093, 4, 1, 2), 'CalcSum with filter Id>=2: 20 + 30 = 50');
    end;
}
