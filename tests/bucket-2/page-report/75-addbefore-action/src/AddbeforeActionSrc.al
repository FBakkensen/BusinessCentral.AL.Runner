...
pageextension 50011 "ABA Product Card Before" extends "ABA Product Card"
{
    actions
    {
        addbefore("New")
...
pageextension 50012 "ABA Product Card BeforeMulti" extends "ABA Product Card"
{
    actions
    {
        addbefore("New")
...
codeunit 50500 "ABA Product Helper"
{
