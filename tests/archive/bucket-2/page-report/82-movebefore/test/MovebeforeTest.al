codeunit 50516 "MBF Movebefore Test"
{
    ...
    [Test]
    procedure PageExtMovebefore_CompilesAndHelperRuns()
    var
        Helper: Codeunit "MBF Product Helper";
    begin
        // Positive: the compilation unit containing a pageextension with `movebefore` in
        // the `layout` area must compile, and codeunits defined alongside must be callable.
        Assert.AreEqual('movebefore ok', Helper.GetLabel(), 'Helper.GetLabel must return movebefore ok');
    end;

    [Test]
    procedure PageExtMovebefore_AddWithBonus()
    var
        Helper: Codeunit "MBF Product Helper";
    begin
    ...
    [Test]
    procedure PageExtMovebefore_AddWithBonus_NotPlainSum()
    var
        Helper: Codeunit "MBF Product Helper";
    begin
    ...
    [Test]
    procedure PageExtMovebefore_Concat()
    var
        Helper: Codeunit "MBF Product Helper";
    begin
    ...
    [Test]
    procedure PageExtMovebefore_Concat_SeparatorPresent()
    var
        Helper: Codeunit "MBF Product Helper";
    begin
    ...
    [Test]
    procedure PageExtMovebefore_TableInCompilationUnit_Usable()
    var
        Product: Record "MBF Product";
    begin
